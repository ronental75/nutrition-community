...
export default {
    ...
    fullDescription: 'א\' בת 23, גובה 157 ס"מ הגיעה בעקבות אמה (ה\'), במשקל התחלתי של 53.6 ק"ג . הצטרפה לתהליך במטרה להתחטב ולהגיע למשקל של 50 ק"ג. באופן הדרגתי ואיטי, א\' נכנסה לשגרת אימונים קבועה המשלבת אימוני כוח ואימונים אירוביים, וכיום היא מתאמנת 4-5 פעמים בשבוע בממוצע. התהליך האיטי והמדורג אפשר לה לשמר את מסת השריר ולהגיע לחיטוב הרצוי. בימים אלה א\' החלה תהליך של שימור!!!',
